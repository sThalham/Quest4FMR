...
# adapted from https://github.com/microsoft/GLIP/blob/main/tools/test_grounding_net.py on 12. Okt, 2024
...
def main():
    glip_t_config = "configs/glip_Swin_T_O365_GoldG.yaml"
    glip_t_swin = ""
    glip_t_model = "https://huggingface.co/GLIPModel/GLIP/resolve/main/glip_tiny_model_o365_goldg_cc_sbu.pth?download=true"
    ...
    parser = argparse.ArgumentParser(description="Glipv2 model loading example")
    ...
    cfg.merge_from_file(glip_t_config) # args.config_file
    ...
    #if args.weight:
    _ = checkpointer.load(state_dict, force=True)
    #else:
            ...
            if log_dir:
                ...
                for output_folder, dataset_name, data_loader_val in zip(output_folders, dataset_names,
                    ...
                    inference(
                        ...
                        iou_types=iou_types,
                        box_only=cfg_.MODEL.RPN_ONLY and (
                                    cfg_.MODEL.RPN_ARCHITECTURE == "RPN" or cfg_.DATASETS.CLASS_AGNOSTIC),
        ...
        if log_dir:
            ...
            for output_folder, dataset_name, data_loader_val in zip(output_folders, dataset_names, data_loaders_val):
                inference(
                    ...
                    dataset_name=dataset_name,
                    iou_types=iou_types,
                    box_only=cfg.MODEL.RPN_ONLY and (
                                cfg.MODEL.RPN_ARCHITECTURE == "RPN" or cfg.DATASETS.CLASS_AGNOSTIC),
